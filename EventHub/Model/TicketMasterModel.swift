...
//    
//    enum CodingKeys: String, CodingKey {
//        case name, type, id, test, url, images, dates, info, pleaseNote, classifications
//        case embedded = "_embedded"
//        
//    }
//}
...
//    
//    enum CodingKeys: String, CodingKey {
//        case name, type, id, test, url, externalLinks, aliases, images, classifications, upcomingEvents
//        case links = "_links"
//    }
//}
//
...
//    
//    enum CodingKeys: String, CodingKey {
//        case name, type, id, test, url, images, postalCode, city, country, address, location, markets, dmas, parkingDetail, accessibleSeatingDetail, generalInfo, upcomingEvents
//        case links = "_links"
